...
class CUI_Dialogue_HackingSuccessMessage final : public CUI
{
public:
...
private:
	explicit CUI_Dialogue_HackingSuccessMessage(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CUI_Dialogue_HackingSuccessMessage(const CUI_Dialogue_HackingSuccessMessage& rhs);
	virtual ~CUI_Dialogue_HackingSuccessMessage() DEFAULT;

public:
	static CUI_Dialogue_HackingSuccessMessage*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
...
private:
	...
	_float			m_fHackingTextScale = 1.8f;
	const _float	m_fHackingTextScaleMin = 1.8f;
	...
	const _uint		m_iLetterOffsetCount = 9;
	const _float	m_fLetterMoveSpeedX = 180.f;
