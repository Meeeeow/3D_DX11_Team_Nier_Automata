...
#ifndef __CLIENT_BEAUVOIR_FIREMISSILE__
#define __CLIENT_BEAUVOIR_FIREMISSILE__
...
class CBeauvoir_FireMissile final : public CGameObjectModel
{
private:
	OBJSTATE m_ePrevState = OBJSTATE::DISABLE;

private:
	explicit CBeauvoir_FireMissile(_pGraphicDevice pGraphicDevice, _pContextDevice pContextDevice);
	explicit CBeauvoir_FireMissile(const CBeauvoir_FireMissile& rhs);
	virtual ~CBeauvoir_FireMissile() DEFAULT;
...
public:
	static	CBeauvoir_FireMissile*	Create(_pGraphicDevice pGraphicDevice, _pContextDevice pContextDevice);
