#pragma once
#ifndef __CLIENT_TREASUREBOX_H__
#define __CLIENT_TREASUREBOX_H__

#include "GameObjectModel.h"

BEGIN(Client)
class CTreasureBox final : public CGameObjectModel
{
public:
	static const _tchar*	TREASUREBOX_OBSERVER_KEY[];
...
private:
	CTreasureBox(_pGraphicDevice pGraphicDevice, _pContextDevice pContextDevice);
	explicit CTreasureBox(const CTreasureBox& rhs);
	virtual ~CTreasureBox() DEFAULT;

public:
	static	CTreasureBox*	Create(_pGraphicDevice pGraphicDevice, _pContextDevice pContextDevice);
...
#endif // !__CLIENT_TREASUREBOX_H__